 ...
 // private addToCartButton: Locator;
  ...
  async getProductDetails() {
    ...
    async verifyArticlePrice() {
        // Wait for the article price to be visible
  ...
  async verifyColorOptions() {
        ...
        expect(isVisible).toBe(true);
        // Uncomment the line below if you want to also check if the color option is enabled
  ...
  async verifyArticleName() {
        // Wait for the article name to be visible
  ...
  async verifySizeSelection() {
        ...
        // Wait for the size options to be visible
      //  await this.sizeOptionSelector.waitFor({ state: 'visible' });
    ...
    private async checkTab(tabSelector: string, contentSelector: string) {
        ...
        await this.page.waitForSelector(contentSelector, { state: 'visible' }); // Wait for the content to be visible
      ...
      async isAddToCartButtonDisabled(): Promise<boolean> {
        ...
        async verifyAddToCartButtonDisabledWhenSizeNotSelected() {
          ...
          async checkSizeOptions(expectedSizes: string[]): Promise<void> {
           ...
           // await this.page.waitForSelector(this.sizeButtonSelector, { state: 'visible' });
